...
export const CategoriaForm: React.FC<CategoriaFormProps> = ({ initialNome = "", loading = false, onSubmit }) => {
    ...
    <form onSubmit={submit}>
      <Box sx={{ backgroundColor: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "16px", p: 4 }}>
        ...
        <Box className="flex justify-end gap-3 mt-8">
          <Button variant="outlined" startIcon={<ArrowBack />} onClick={() => navigate("/cadastros/categorias")} sx={{ textTransform: "none" }}>
            Cancelar
          </Button>
