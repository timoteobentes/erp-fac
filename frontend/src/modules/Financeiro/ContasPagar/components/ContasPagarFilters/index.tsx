...
import type { FiltrosContaPagar } from '../../services/contasPagarService';

interface ContasPagarFiltersProps {
  filtros: FiltrosContaPagar;
  setFiltros: React.Dispatch<React.SetStateAction<FiltrosContaPagar>>;
  onBuscar: () => void;
  onLimpar: () => void;
}
...
export const ContasPagarFilters: React.FC<ContasPagarFiltersProps> = ({
  filtros,
  setFiltros,
  onBuscar,
  onLimpar
    ...
    <Box className='flex flex-col gap-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <FormControl fullWidth size="small" sx={premiumInputStyles}>
          <InputLabel id="status-filtro-label">Status da Conta</InputLabel>
          <Select
