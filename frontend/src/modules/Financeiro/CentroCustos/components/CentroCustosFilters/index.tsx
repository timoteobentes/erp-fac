    ...
    <Box className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <FormControl fullWidth size="small" sx={premiumInputStyles}>
          <InputLabel id="status-centro-custo-label">Status</InputLabel>
          <Select labelId="status-centro-custo-label" value={filtros.status || ""} label="Status" onChange={handleStatusChange}>
